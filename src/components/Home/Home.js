...
import me from "../../Assets/clown.png";
                ...
                <div>
                  <ul className="home-about-social-links">
                    <li className="social-icons">
                      <a
                        href="https://github.com/mohtashimbutt"
                        target="_blank"
                        rel="noreferrer"
                    ...
                    <li className="social-icons">
                      <a
                        href="https://twitter.com/SakhtLo58473277"
                        target="_blank"
                        rel="noreferrer"
                        className="icon-colour  home-social-icons"
                      >
                    ...
                    <li className="social-icons">
                      <a
                        href="https://www.linkedin.com/in/mohtashim-butt-a451b5206/"
                        rel="noreferrer"
                        target="_blank"
                        className="icon-colour  home-social-icons"
                      >
